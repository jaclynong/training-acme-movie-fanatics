...
public class EventLocalServiceWrapper implements EventLocalService,
	...
	*/
	...
	public java.util.List<com.liferay.training.amf.monitor.model.Event> getEvents(
		...
		return _eventLocalService.getEvents(groupId, start, end, comparator);
	}
	...
	public java.util.List<com.liferay.training.amf.monitor.model.Event> getEvents(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.training.amf.monitor.model.Event> comparator) {
		return _eventLocalService.getEvents(userName, start, end, comparator);
	}
	...
	public java.util.List<com.liferay.training.amf.monitor.model.Event> getEvents(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.training.amf.monitor.model.Event> comparator) {
		return _eventLocalService.getEvents(userName, eventType, start, end,
			comparator);
	}

	@Override
	public java.util.List<com.liferay.training.amf.monitor.model.Event> getEventsByEventType(
